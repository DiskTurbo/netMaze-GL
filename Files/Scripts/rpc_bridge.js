...
let HANDSHAKE_SDK_VERSION = "[[[ SDK_VERSION ]]] 1.6.1§";
...
let disableInfoLogs = "[[[ DISABLE_INFO_LOGS ]]] False§";
...
function Handshake() {
    ...
    const clientIdVariable = "[[[ CLIENT_ID ]]] 1219430872021991546§";
...
async function InitialBridgeListener(message) {
    ...
    switch (command) {
        case COMMANDS.Dispatch: {
            ...
            const disableLogOverrideVariable = "[[[ DISABLE_CONSOLE_LOG_OVERRIDE ]]] True§";
            ...
            const patchUrlMappingsConfigVariable = "[[[ PATCH_URL_MAPPINGS_CONFIG ]]] patchFetch,True,patchWebSocket,True,patchXhr,True,patchSrcAttributes,False§";
            ...
            const oauthScopesVariable = "[[[ OAUTH_SCOPES ]]] identify§";
        ...
        case COMMANDS.Authorize: {
            ...
            const tokenRequestPathVariable = "[[[ TOKEN_REQUEST_PATH ]]] /api/token§";
            const tokenRequestPath = ParseBuildVariable(tokenRequestPathVariable, "string");
            const serverRequestVariable = '[[[ SERVER_REQUEST ]]] {"code":null}§';
